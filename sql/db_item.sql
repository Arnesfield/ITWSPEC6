...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2017 at 12:27 PM
...
(3, 'Orange', 'Sour', 13.00, 1505557595, 1505557595, 'orange', '1'),
...
--
ALTER TABLE `tbl_item`
  MODIFY `item_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;COMMIT;
